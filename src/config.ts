...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    LinkPreset.Archive,
    LinkPreset.About,
    LinkPreset.Resources,
    {
      name: 'GitHub',
      url: 'https://github.com/LingXi9374',     // Internal links should not include the base path, as it is automatically added
