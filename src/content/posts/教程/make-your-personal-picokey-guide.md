...
虽然说它在计算机发展史上也是比较 ~~老资历~~ 关键的进程了，但它核心在于「**安全**」啊！至今貌似没什么人敢破解(存疑?)，:spoiler[因为敢破解的应该都吃了紫菜蛋花汤没有菜花汤了]基本都是银行或密钥提供商自家漏洞导致的大小规模的泄露事件会引起安全令牌的失效。而今这类事件发生的概率小到极点:sopiler[Ｍ＄这个草台班子咖喱味互联网公司就不好说了（（（]，大家可以放心使用。
...
看到这个产品，我想说的一句话是：__这太TM贵了！__ 这样的价格对我一个 ~~安卓人~~ 来说是承担不起的（（。如果这样的小玩意弄丢了，这将是一个极大的损失（同时账号也丢了）！
...
或者使用[Picoforge](https://sst311212.github.io/pico-fido2/)项目进行本地配置，
...
咱们 DIY 定制的硬件密钥本质上也只是一个小小的 USB 单片机，仔细想想这样一个电路板裸露出来未免也不太好，还容易损坏。网络上目前的方案是热熔胶套上或者 3D 打印树脂外壳，这样就不用再担心使用过程中的损耗了。
...
__编撰于 公元 2026 年 5 月 2 日 农历三月十六__